...
import 'package:resik_app/src/ui/nasabah/histori/modal_tarik.dart';
...
class Penarikan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final history = historiCon.historyWidraw.value;
  ...
  Future<void> showDetail(BuildContext context, HistoryWidrawModel item) async {
    Modals.showCupertinoModal(
      context: context,
      builder: ModalWidrawUI(item: item),
    );
  }

  Widget _itemHistori(BuildContext context, HistoryWidrawModel item) {
